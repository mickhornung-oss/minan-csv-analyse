# Skriptinventar (Freeze-Stand MinAn 1.4)

## Produktnahe Skripte (aktiv)
- `block3_produktcheck.py`
- `block3_stresstest_analysis.py`
- `produktcheck_charts.py`
- `produktcheck_charts_detailed.py`
