...
class TestStressTestTypology:
    ...
    def test_missing_values_logic(self, stresstest_df):
        ...
        zweites_produkt_col = next(c for c in profile.columns if c.name == 'Zweites_Produkt')
    ...
    def test_type_sums_are_consistent(self, stresstest_df):
        ...
        total = (profile.numeric_columns + profile.categorical_columns +
                 profile.datetime_columns + profile.id_columns + profile.text_columns + profile.unknown_columns)
